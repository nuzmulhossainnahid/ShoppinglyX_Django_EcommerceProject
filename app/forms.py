...
class CustomerResistationForm(UserCreationForm):
...
class MypasswordchangeForm(PasswordChangeForm):
    old_password = forms.CharField(label=("Old Password"),strip=False, widget=forms.PasswordInput(attrs={'autocomplete': 'old-password', 'class': 'form-control'}))
...
class CustomerProfileForm(forms.ModelForm):
    class Meta:
        ...
        'state':forms.Select(attrs={'placeholder': 'Select Your State','class':'form-control'}),
